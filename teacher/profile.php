        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card p-4 border-0 shadow-sm rounded-4 text-center">
                    <img src="../uploads/profiles/<?php echo $user['profile_pic'] ? $user['profile_pic'] : 'default.png'; ?>" class="rounded-circle mx-auto mb-3" style="width:120px; height:120px; object-fit:cover; border:3px solid #4e73df;">
